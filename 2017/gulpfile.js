...
gulp.task("browser-sync", function () {
    ...
    gutil.log(gutil.colors.green.bold("🌠 💝 Welcome to the bs world of"), gutil.colors.yellow.bold("~ unicorns ~"), gutil.colors.green.bold("( ˘ ³˘)💝 🌈 "));
});
...
gulp.task("bs-reload", function () {
    browserSync.reload();
    gutil.log(gutil.colors.white.bgBlue("⭐ Unicorns love a refreshing waterfall for breakfast ⭐"));
});
...
gulp.task("styles", ["scss"], function () {
    ...
    return gulp.src(cwd + "/style.css")
        ...
        .on("end", function () {
            gutil.log(gutil.colors.white("👑 Unicorns need"), gutil.colors.blue("s"), gutil.colors.yellow("t"), gutil.colors.green("y"), gutil.colors.gray("l"), gutil.colors.red("e"), gutil.colors.cyan("s"), gutil.colors.white("to turn into dragons 🐲"));
        });
});
...
gulp.task("plaincss", function () {
    return gulp.src([cwd + "/*.css", "!" + cwd + "/style.css", "!" + cwd + "/style.min.css"])
        ...
        .on("end", function () {
            gutil.log(gutil.colors.white("👑 Rainbows now appear in ten different shades"));
        });
});
